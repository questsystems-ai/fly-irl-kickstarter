        ...
        <div className="stat-grid">
          <div className="stat-card">
            <img src="/images/problem-cost.jpg" alt="Cost barrier" style={{
              width: '100%', height: 80, objectFit: 'cover', borderRadius: 6, marginBottom: 14, display: 'block',
            }} />
          ...
          <div className="stat-card">
            <img src="/images/problem-danger.jpg" alt="GA danger" style={{
              width: '100%', height: 80, objectFit: 'cover', borderRadius: 6, marginBottom: 14, display: 'block',
            }} />
          ...
          <div className="stat-card">
            <img src="/images/problem-dream.jpg" alt="Universal dream of flight" style={{
              width: '100%', height: 80, objectFit: 'cover', borderRadius: 6, marginBottom: 14, display: 'block',
            }} />
      ...
      <Slide dark>
        ...
        <div className="steps-row">
          <div className="step-card">
            <img src="/images/step-you-fly.jpg" alt="You fly" style={{
              width: '100%', height: 120, objectFit: 'cover', borderRadius: 6, marginBottom: 14, display: 'block',
            }} />
          ...
          <div className="step-card">
            <img src="/images/step-ai-watches.jpg" alt="AI watches" style={{
              width: '100%', height: 120, objectFit: 'cover', borderRadius: 6, marginBottom: 14, display: 'block',
            }} />
          ...
          <div className="step-card">
            <img src="/images/step-safety-catches.jpg" alt="Safety catches" style={{
              width: '100%', height: 120, objectFit: 'cover', borderRadius: 6, marginBottom: 14, display: 'block',
            }} />
